...
public:
    ...
    void setupUi(QWidget *MyWidget)
    {
        ...
        widget->setGeometry(QRect(50, 220, 1431, 461));
    ...
    void retranslateUi(QWidget *MyWidget)
    {
        ...
        flap_motor1->setText(QApplication::translate("MyWidget", "\346\211\221\345\212\250\347\224\265\346\234\272", 0));
